...
\begin{document}
    ...
    \begin{frame}{Augmented Settings}
        ...
        \begin{itemize}
            ...
            \pause\item Dynamics $\ov{P}$ %$\ov{P}\left((s',\beta') \condbar (s,\beta), (a, \beta_a)\right) \eqdef P(s'|s, a)\delta(\beta' - \beta_a)$.
        \end{itemize}
        \textbf{2D signals}
        \begin{enumerate}
    ...
    \begin{frame}{Experiments: autonomous driving}
        \href{../../assets/highway-env.html}{\beamergotobutton{BFTQ on the highway environment}}
